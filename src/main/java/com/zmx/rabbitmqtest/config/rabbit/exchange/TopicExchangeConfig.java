...
public class TopicExchangeConfig {
	@Bean
 	public TopicExchange topicExchange(){
		TopicExchange topicExchange=new TopicExchange("zmx-topic");
 		return topicExchange;
 	}
	
	@Bean
    public Queue topicQueue1() {
       Queue queue=new Queue("zmx-topicqueue1");
       return queue;
    }
 	
 	@Bean
    public Queue topicQueue2() {
       Queue queue=new Queue("zmx-topicqueue2");
       return queue;
    }
